...
function Footer() {
    return (
        ...
        <div className="footer-img pt-4 pb-3 pt-lg-5 pb-lg-4 ">
            <div className="row pt-2 pt-lg-0 row">
                <div className="pb-2 mb-4 col-lg-3">
                    ...
                    <form className="form-group form-group-light">
                        <div className="input-group input-group-sm"><span className="text-muted input-group-text" ><i class="fa fa-regular fa-envelope"></i></span><input placeholder="Your email" className="form-control" /></div><button  type="button" className= "btn btn-s btn-icon btn-sm "><i class="fa fa-regular fa-paper-plane fb "></i> </button>
                    </form>
                </div>
